...
public class Citas extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private Date dateseleccionado=null;

    public static ArrayList<String> arraydatosFecha = new ArrayList<>();
    public static ArrayList<String> arraydatosHora = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(Citas.this, calendar1.get(Calendar.YEAR), calendar1.get(Calendar.MONTH), calendar1.get(Calendar.DAY_OF_MONTH));
        ...
        enviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                java.util.Date dateactual = new java.util.Date(); // Fecha actual del sistema


               // Toast.makeText(getApplicationContext(),"el valor fechaactual es "+dateactual , Toast.LENGTH_SHORT).show();
               // Toast.makeText(getApplicationContext(),"el valor fechaseleccionada es "+dateseleccionado , Toast.LENGTH_SHORT).show();
    ...
    public void comprobarCita(){
        ...
        for (int i=0 ; i<arraydatosFecha.size();i++){
            if (arraydatosHora.get(i).equals(hora) && arraydatosFecha.get(i).equals(fecha)){
